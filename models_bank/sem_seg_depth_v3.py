...
from segmentation_heads.sem_seg_with_depth import segmentation_head as sem_seg_head
...
class Semseg_Depth(nn.Module):
    ...
    def forward(self, img, sparse_depth, mask, coors, k_nn_indices, sparse_depth_gt=None, semantic_masks=None):
        ...
        fused, _, _, _ = self.fuse_conv((y_rgbd_cat_y_sparse, mask, coors, k_nn_indices))
