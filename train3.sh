...
#SBATCH --output=res/res_train_fusenet_%a.txt
#SBATCH --error=res/err_train_fusenet_%a.txt
#
#!/bin/bash
...
python train_fusenet.py --nodes=1 --ngpus=4 --ip_adress $ip1 $SLURM_TASK_ARRAY_ID