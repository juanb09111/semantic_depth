...
#SBATCH --output=res/res_train_semseg_depth_v3_%a.txt
#SBATCH --error=res/err_train_semseg_depth_v3_%a.txt
#
#!/bin/bash
...
python train_semseg_depth_v3.py --nodes=1 --ngpus=4 --ip_adress $ip1 $SLURM_TASK_ARRAY_ID