...
def inference_sem_seg_depth(model, data_loader_val, weights_file):
    ...
    with torch.no_grad():
        ...
        for imgs, _, lidar_fov, masks, sparse_depth, k_nn_indices, sparse_depth_gt, sparse_depth_gt_full, basename in data_loader_val:
            ...
            for idx in range(len(outputs)):
                ...
                loc = "{}/{}".format(constants.INFERENCE_RESULTS, "FuseNet")
...
if __name__ == "__main__":
    ...
    model = models.get_model_by_name("FuseNet")
