...
def dense_optical_flow(method, prev_img_fname, next_image_fname, params=[], to_gray=False):
    ...
    flow = method(prev_img, next_img, None, *params)
...
def cal_flow(algorithm, prev_img_fname, next_image_fname):

    if algorithm == 'lucaskanade_dense':
        method = cv2.optflow.calcOpticalFlowSparseToDense
        frames = dense_optical_flow(method, prev_img_fname, next_image_fname, params=[], to_gray=True)
